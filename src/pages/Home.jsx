...
//         <div className="grid xl:grid-cols-4 md:grid-cols-2 lg:grid-cols-3 grid-cols-1 mt-11 gap-11 p-4 lg:px-10 md:px-28 justify-items-center">
//           {data &&
//             data.map((product) => (
//               <div key={product.id}>
...
export default function Home() {
  ...
  return (
    <div className="home">
      <div className="align-content">
        <h1 className="text-4xl text-center font-bold mt-10">Home</h1>
        <div className="grid xl:grid-cols-4 md:grid-cols-2 lg:grid-cols-3 grid-cols-1 mt-11 gap-4 p-4 lg:px-10 md:px-28 justify-items-center">
          {data &&
            data.map((product) => (
              <div key={product.id}>
                <Card product={product} />
