        ...
        <div className="max-w-[445px] h-[426px] mx-auto mt-16 ">
          ...
          <div className="mt-10  flex items-center gap-4 ">
            <div className="flex items-center border rounded-lg bg-base-300 btn btn-md">
              <button
                className="w-8 h-8 leading-10 text-gray-600 transition hover:opacity-75 text-purple-600 font-extrabold text-2xl"
              ...
              />
              <button
                className="w-10 h-10 leading-10 text-purple-600 font-extrabold text-2xl transition hover:opacity-75"
            ...
            <button
              className="flex items-center btn bg-purple-600 text-white btn-md font-bold w-64 py-2 px-4 rounded-lg shadow hover:bg-purple-700 transition"
