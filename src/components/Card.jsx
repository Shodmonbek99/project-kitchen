...
//       try {
//         await deleteDoc(doc(db, "eda", String(product.id))); 
...
//     <div className="card">
//       <div 
//         className="card-image top-section"
...
//       </div>
//       <Toaster />
//       <div className="card-content bottom-section cursor-pointer" onClick={navigateLink}>
//         <span className="title">{product.name}</span>
//         <div className="row row1">
//           <div className="item">
//             <span className="big-text">{product.cookingTime} min</span>
...
//   return (
//     <div className="card">
//       <div className="card-image" style={{ backgroundImage: `url(${product.img[0]})` }}>
...
//       </div>
//       <Toaster />
//       <div className="card-content" onClick={navigateLink}>
//         <h3 className="card-title">{product.name}</h3>
//         <div className="card-details">
//           <div className="detail-item">
//             <span className="detail-value">{product.cookingTime} min</span>
...
const Card = ({ product }) => {
  ...
  return (
    <div className="card" onClick={navigateLink}>
      <div
